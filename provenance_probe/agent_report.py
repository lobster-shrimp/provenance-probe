...
<title>Agent provenance — {html.escape(title)}</title>
<style>
 :root {{ --bad:#b00020; --warn:#b26a00; --ok:#1b7f4d; --unk:#555; --line:#e3e3e3; }}
...
<p>This assesses an {_tip("agent", "agent")} (a multi-step, multi-model workflow), reporting per step which model ran it,
whether the {_tip("model switched", "model switch")}, and where {_tip("tool calls sent data", "egress")}.
The two verdicts are kept separate: {_tip("provenance", "provenance")} (whose weights) and {_tip("jurisdiction", "jurisdiction")} (who runs it, where).
{_tip("Trace", "trace")}-only provenance floors at {_tip("INDETERMINATE", "INDETERMINATE")}; {_tip("CONFIRMED", "CONFIRMED")} needs the {_tip("active backend probe", "active probe")}.</p>
